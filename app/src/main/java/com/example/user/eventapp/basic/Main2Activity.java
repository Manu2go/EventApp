...
import com.example.user.eventapp.basic.ins_study;

public class Main2Activity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    TextView name,mobile,email,name1;
    NavigationView nv;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mobile.setText(sh.getString("mobile","-------"));
        email.setText(sh.getString("email","-------"));
        name1.setText(sh.getString("name","-------"));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.insert_student) {
            startActivity(new Intent(this,ins_study.class));
        } else if (id == R.id.assign_duties) {
            startActivity(new Intent(this,ass_stud.class));
